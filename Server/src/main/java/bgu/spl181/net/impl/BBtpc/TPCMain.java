...
import bgu.spl181.net.impl.SharedProtocolMovieUsersData;
...
public class TPCMain {
    public static void main(String[] args) {
        ...
        SharedProtocolMovieUsersData sharedProtocolData = new SharedProtocolMovieUsersData(connectionsImpl);
